...
namespace AppStudio.ViewModels
{
    public class AboutThisAppViewModel
    {
        ...
        public string AboutText
        {
            get
            {
                return "This app gives u brief knowledge of how to play musical instruments...And describ" +
    "es the types of instruments.....In short it is a brief Organology (study of musi" +
    "cal instruments)";
            }
        }
    }
