...
namespace AppStudio.Controls
{
    public sealed partial class WebControl : UserControl
    {
        ...
        const string HTML_PATTERN = "<!DOCTYPE html><html><head><style>body, html {{margin: 0px; padding: 0px; color: #{0}; font-family: Segoe UI; font-size: 1em; }} li{{font-size: 2.5em;}}</style></head><body>{1}</body></html>";
#endif
#if WINDOWS_APP
