...
{
    /// <summary>
    /// Implementation of the KEYBOARDSchema class.
    /// </summary>
    public class KEYBOARDSchema : BindableSchemaBase, IEquatable<KEYBOARDSchema>
    {
        ...
        public bool Equals(KEYBOARDSchema other)
        {
            if (other == null)
            {
                return false;
