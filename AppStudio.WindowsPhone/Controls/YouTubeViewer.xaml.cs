...
namespace AppStudio.Controls
{
    public sealed partial class YouTubeViewer : UserControl, INotifyPropertyChanged
    {
        ...
        private YouTubeSchema _selectedItem;
        ...
        public static readonly DependencyProperty FullScreenProperty =
            DependencyProperty.Register("FullScreen", typeof(bool), typeof(YouTubeViewer), new PropertyMetadata(false, OnFullScreenChanged));
        ...
        public double WebViewScaleHeight
        {
            get { return FullScreen ? this.WebView.ActualWidth / this.ActualHeight : 1; }
        }

        public double WebViewScaleWidth
        {
            get { return FullScreen ? this.ActualHeight / this.WebView.ActualWidth : 1; }
        }

        public int WebViewAngle
        {
            get { return FullScreen ? 90 : 0; }
        }
        ...
        {
            YouTubeViewer viewer = d as YouTubeViewer;
            if (viewer != null)
            {
                viewer.OnPropertyChanged("FullScreen");
                viewer.OnPropertyChanged("WebViewAngle");
                viewer.OnPropertyChanged("WebViewScaleWidth");
                viewer.OnPropertyChanged("WebViewScaleHeight");
            }
        }
