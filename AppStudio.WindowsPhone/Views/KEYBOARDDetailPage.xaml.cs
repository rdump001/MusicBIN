...
{
    public sealed partial class KEYBOARDDetail : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            KEYBOARDModel.SelectItem(e.Parameter);

            if (KEYBOARDModel != null)
            {
                KEYBOARDModel.ViewType = ViewTypes.Detail;
            }
            DataContext = this;
        }
        ...
        private void OnDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            if (KEYBOARDModel != null)
            {
                KEYBOARDModel.GetShareContent(args.Request);
            }
        }
    }
}
